...
const int I2C_TIME_OUT_BASE = 1;
const int I2C_TIME_OUT_BYTE = 1;

int _I2CWrite(uint8_t *pdata, uint32_t count) {
	int i2c_time_out = I2C_TIME_OUT_BASE+ count* I2C_TIME_OUT_BYTE;
	return HAL_I2C_Master_Transmit(&hi2c1, 0x52, pdata, count, 5);

}

int _I2CRead(uint8_t *pdata, uint32_t count) {
	int i2c_time_out = I2C_TIME_OUT_BASE+ count* I2C_TIME_OUT_BYTE;
    return HAL_I2C_Master_Receive(&hi2c1, 0x52, pdata, count, 5);
}
...
void writeReg(uint8_t reg, uint8_t value) {
    _I2CBuffer[0] = reg>>8;
    _I2CBuffer[1] = reg&0xFF;
    _I2CBuffer[2] = value;

    _I2CWrite(_I2CBuffer, 3);
}
...
void writeReg16Bit(uint8_t reg, uint16_t value){
	_I2CBuffer[0] = reg>>8;
    _I2CBuffer[1] = reg&0xFF;
    _I2CBuffer[2] = value >> 8;
    _I2CBuffer[3] = value & 0x00FF;

    _I2CWrite(_I2CBuffer, 4);
}
...
void writeReg32Bit(uint8_t reg, uint32_t value){
    _I2CBuffer[0] = reg>>8;
    _I2CBuffer[1] = reg&0xFF;
    _I2CBuffer[2] = (value >> 24) & 0xFF;
    _I2CBuffer[3] = (value >> 16) & 0xFF;
    _I2CBuffer[4] = (value >> 8)  & 0xFF;
    _I2CBuffer[5] = (value >> 0 ) & 0xFF;
    _I2CWrite(_I2CBuffer, 6);
}
...
uint16_t readReg16Bit(uint8_t reg) {
	...
	_I2CBuffer[1] = reg&0xFF;
    _I2CWrite(_I2CBuffer, 2);
    _I2CRead(_I2CBuffer, 2);
    return ((uint16_t)_I2CBuffer[0]<<8) + (uint16_t)_I2CBuffer[1];
}
...
uint32_t readReg32Bit(uint8_t reg) {
	...
	_I2CBuffer[1] = reg&0xFF;
	_I2CWrite(_I2CBuffer, 2);
    _I2CRead(_I2CBuffer, 4);
    return ((uint32_t)_I2CBuffer[0]<<24) + ((uint32_t)_I2CBuffer[1]<<16) + ((uint32_t)_I2CBuffer[2]<<8) + (uint32_t)_I2CBuffer[3];
}
...
void writeMulti(uint8_t reg, uint8_t const *src, uint8_t count){
    _I2CBuffer[0] = reg>>8;
    _I2CBuffer[1] = reg&0xFF;
    memcpy(&_I2CBuffer[2], src, count);
    _I2CWrite(_I2CBuffer, count + 2);
}
